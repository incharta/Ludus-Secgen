...
Gem::Specification.new do |spec|
	...
	spec.license = 'MIT'
	spec.authors = ['Dirk Grappendorf', 'Tim Vlpel', 'Sebastian Bremicker', 'Sebastian Lehn']
	spec.email = ['dirk.grappendorf@telcat.de', 'tim.voelpel@telcat.de', 'sebastian.bremicker@telcat.de', 'lehn@etracker.com']
